...
// Game action constants — used in Message.Payload as the "action" field.
const (
	GameActionStart        = "game_start"
	GameActionState        = "game_state"
	GameActionModeSelect   = "game_mode_select"
	GameActionArtistAdd    = "game_artist_add"
	GameActionArtistRemove = "game_artist_remove"
	GameActionGenreSelect  = "game_genre_select"
	GameActionBegin        = "game_begin"
	GameActionRoundStart   = "game_round_start"
	GameActionAnswer       = "game_answer"
	GameActionRoundEnd     = "game_round_end"
	GameActionEnd          = "game_end"
	GameActionLeave        = "game_leave"
	GameActionError        = "game_error"
)
